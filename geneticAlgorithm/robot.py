...
class ROBOT:
    ...
    def send_objects(self, sim):
        ...
        # send in an object
        self.O0 = sim.send_box(x=0, y=0, z=c.L + c.R, length=c.L, width=c.L, height=c.R * 2, r=.5, g=.5, b=.5)
        ...
        # sends a cylinder into environment
        self.O2 = sim.send_cylinder(x=0, y=-c.L, z=c.L + c.R, length=c.L, radius=c.R, r=0, g=0, b=1, r1=0, r2=1, r3=0)

        # sends a cylinder into environment
        self.O3 = sim.send_cylinder(x=c.L, y=0, z=c.L + c.R, length=c.L, radius=c.R, r=0, g=1, b=0, r1=1, r2=0, r3=0)

        # sends a cylinder into environment
        self.O4 = sim.send_cylinder(x=-c.L, y=0, z=c.L + c.R, length=c.L, radius=c.R, r=1, g=0, b=1,  r1=1, r2=0, r3=0)

        # sends a cylinder into environment
        self.O5 = sim.send_cylinder(x=0, y=c.L+c.L/2, z=(c.L)/2 + c.R, length=c.L, radius=c.R, r=1, g=0, b=0, r1=0, r2=0, r3=1)

        # sends a cylinder into environment
        self.O6 = sim.send_cylinder(x=0, y=-c.L-c.L/2, z=(c.L)/2 + c.R, length=c.L, radius=c.R, r=0, g=0, b=1, r1=0, r2=0, r3=1)

        # sends a cylinder into environment
        self.O7 = sim.send_cylinder(x=c.L+c.L/2, y=0, z=(c.L)/2 + c.R, length=c.L, radius=c.R, r=0, g=1, b=0, r1=0, r2=0, r3=1)

        # sends a cylinder into environment
        self.O8 = sim.send_cylinder(x=-c.L-c.L/2, y=0, z=(c.L)/2 + c.R, length=c.L, radius=c.R, r=1, g=0, b=1, r1=0, r2=0, r3=1)
